...
public class MeusAnunciosAdapter extends PagingDataAdapter<Anuncio, MyViewHolder> {
    MeusAnunciosActivity meusAnunciosActivity;

    public MeusAnunciosAdapter(@NonNull DiffUtil.ItemCallback<Anuncio> diffCallback) {
        super(diffCallback);
    }

    public MeusAnunciosAdapter(MeusAnunciosActivity meusAnunciosActivity, @NonNull DiffUtil.ItemCallback<Anuncio> diffCallback) {
        super(diffCallback);
        this.meusAnunciosActivity = meusAnunciosActivity;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (anuncio.img != null) {
            int h = (int) meusAnunciosActivity.getResources().getDimension(R.dimen.img_height_anuncio);
            ImageView imvImagemAnuncio = holder.itemView.findViewById(R.id.imvImagemAnuncio);
            ImageCache.loadImageUrlToImageView(meusAnunciosActivity, anuncio.img, imvImagemAnuncio, -1, h);
        }
