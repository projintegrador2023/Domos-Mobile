...
public class CriarAnuncioViewModel extends AndroidViewModel {
     ...
     */
    public LiveData<Boolean> criarAnuncio(String name, String tag, String description, String imgLocation) {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // em caso contrário
                boolean b = domosRepository.criarAnuncio(name, tag, description, imgLocation);
