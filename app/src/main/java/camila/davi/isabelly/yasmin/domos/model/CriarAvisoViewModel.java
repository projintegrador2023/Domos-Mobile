...
public class CriarAvisoViewModel extends AndroidViewModel {
    ...
    public LiveData<Boolean> criarAviso(String titulo, String importancia, String descricao) {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // em caso contrário
                boolean b = domosRepository.criarAviso(titulo, importancia, descricao);
    ...
    public LiveData<List<String>> pegarImportancia() {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // em caso contrário
                List<String> b = domosRepository.loadImportancia();
