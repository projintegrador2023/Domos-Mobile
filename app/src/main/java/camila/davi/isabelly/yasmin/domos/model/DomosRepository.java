...
public class DomosRepository {
    ...
    public boolean editarPerfil(String nome, String email, String senha, String imgLocation) {

        String login = Config.getLogin(context);
        String password = Config.getPassword(context);

        // Cria uma requisição HTTP a adiona o parâmetros que devem ser enviados ao servidor
        HttpRequest httpRequest = new HttpRequest(Config.DOMOS_APP_URL + "editar_perfil.php", "POST", "UTF-8");
