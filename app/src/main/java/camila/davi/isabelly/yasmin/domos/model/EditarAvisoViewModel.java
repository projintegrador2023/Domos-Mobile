...
public class EditarAvisoViewModel extends AndroidViewModel {
    public EditarAvisoViewModel(@NonNull Application application) {
        super(application);
    }
    public LiveData<Boolean> editarAviso(String titulo, String tag, String descricao) {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // em caso contrário
                boolean b = domosRepository.criarAviso(titulo, tag, descricao);
